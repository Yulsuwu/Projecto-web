...
const pizzas = [
    ...
    },
    {
        id: 3,
        nombre: "Mexicana",
        descripcion: "Pizza con jalapeños, carne molida, pimiento y cebolla",
        imagen: "/pizza.png"
    }
];

const tamaños = [
    { tamaño: "Pequeña", precio: 90 },
    { tamaño: "Mediana", precio: 150 },
    { tamaño: "Grande", precio: 200 }
];

const PizzaDetails = ({ onAddToCart }) => {
    ...
    const handleAddToCart = () => {
        if (selectedPizza && selectedSize) {
            const pizzaToAdd = {
                ...
                nombre: `Pizza ${selectedPizza.nombre} ${selectedSize.tamaño}`,
                    ...
                    <Grid item xs={12} sm={6} md={4} key={pizza.id}>
                        <Card 
                            sx={{ 
                                ...
                                transform: selectedPizza?.id === pizza.id ? 'scale(1.05)' : 'scale(1)',
                                border: selectedPizza?.id === pizza.id ? '3px solid #d32f2f' : 'none',
                                boxShadow: selectedPizza?.id === pizza.id 
